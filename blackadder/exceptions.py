"""
Custom exceptions for Blackadder.
...
class BlackadderException(Exception):
    """Base exception for all Blackadder errors."""

    pass


# Database Exceptions
class DatabaseError(BlackadderException):
...
# File Exceptions
class FileError(BlackadderException):
...
class ELFError(BlackadderException):
...
class ProcessError(BlackadderException):
...
class SymbolError(BlackadderException):
...
class SubprocessError(BlackadderException):
...
class ValidationError(BlackadderException):
...
class ResourceLimitError(BlackadderException):
...
# Parsing Exceptions
class ParseError(BlackadderException):
