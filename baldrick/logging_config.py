"""
Logging configuration for Baldrick.
...
def setup_logging(log_level: str = "INFO", log_file: str | None = None) -> logging.Logger:
    ...
    """
    # Get root logger
    logger = logging.getLogger("baldrick")
...
def get_logger(name: str) -> logging.Logger:
    ...
    Returns:
        Logger instance
    """
    return logging.getLogger(f"baldrick.{name}")


# Module-level loggers for key components
logger = logging.getLogger("baldrick")
parser_logger = logging.getLogger("baldrick.parser")
db_logger = logging.getLogger("baldrick.db")
analyzer_logger = logging.getLogger("baldrick.analyzer")
cli_logger = logging.getLogger("baldrick.cli")
