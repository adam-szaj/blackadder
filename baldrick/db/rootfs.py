...
logger = logging.getLogger("baldrick.db.rootfs")
...
class RootfsDatabase:
    ...
    async def load_binary(
        ...
        from baldrick.binutils.debuginfo import find_debug_file
    ...
    async def collect_binary_payload(
        ...
        """
        from baldrick.binutils.debuginfo import find_debug_file
        from baldrick.binutils.dwarf_parser import _sync_parse_debug_line, _sync_parse_dwarf_types
        from baldrick.binutils.parser import BinToolsParser
