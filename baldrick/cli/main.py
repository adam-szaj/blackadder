"""
Baldrick CLI - main entry point for baldrick debugging tool.
...
from baldrick.db.rootfs import PAYLOAD_SENTINEL, RootfsDatabase
from baldrick.logging_config import setup_logging
from baldrick.theme import ColorTheme, load_theme

logger = logging.getLogger("baldrick.cli")
...
def _get_config_or_default() -> BaldrickConfig:
...
def _db_manager(db: str | None, config: BaldrickConfig) -> AsyncDatabaseManager:
...
async def cast_mem(
    ...
    """
    from baldrick.dwarf_query import get_binary_id, resolve_and_flatten
    ...
    try:
        ...
        if existing is None:
            ...
            if core_file:
                ...
                from baldrick.models import ProcessSnapshot as _PS
        ...
        from baldrick.models import BinaryLocator
        ...
        from baldrick.models import Thread as ThreadModel
...
async def decode_address(
    ...
    try:
        from baldrick.binutils import resolve_symbol
...
async def report(
    ...
    try:
        ...
        # ── Rich output ───────────────────────────────────────────────────────
        console.print()
        console.print("[bold cyan]═══ Baldrick Debug Report ═══[/bold cyan]")
...
def main():
    ...
    from baldrick.queries import expand_aliases
